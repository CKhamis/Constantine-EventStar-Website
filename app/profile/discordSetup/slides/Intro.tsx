...
export default function Intro(){
    return (
        <div className="flex flex-col gap-7 justify-center items-center mt-8">
            ...
            <p className="text-2xl w-[900] text-center">This will set up Discord communications with your EventStar account, allowing for instant event reminders, alerts, and more!</p>
